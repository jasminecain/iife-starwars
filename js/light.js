...
var Starwars = (function(originalStarwars) {
  ...
  originalStarwars.getLocation = function(whoAsks) {
    ...
    if (tell) {
      console.log(whoAsks, 'is on the goodside. Location:', location);
    } else {
...
})(Starwars);  //passing in functions inside this parameter; augmenting this obj by adding more methods
//originalStarwars replaces it with Starwars.
// addJedi pushing to keyPlayers, staying inside the function
